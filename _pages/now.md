...
<div class="now-page">
    ...
    <section class="now-section">
        ...
        <div class="project-card">
            ...
            <p class="project-description">
                Reference implementations of LLM acceleration techniques including speculative decoding (EAGLE, Medusa, tree speculation), KV-cache compression, and custom Triton kernels for transformer operations. Achieves 8.1x speedup with 88% peak bandwidth utilization on A100 GPUs. Open-source repos: <a href="https://github.com/bassrehab/speculative-decoding" target="_blank">speculative-decoding</a> and <a href="https://github.com/bassrehab/triton-kernels" target="_blank">triton-kernels</a>. Google Technical Disclosure pending.
            </p>
        </div>
    ...
    <section class="now-section">
        ...
        <div class="section-content">
            <ul class="now-list">
                <li><i class="fas fa-brain"></i> <strong>Multi-Agent Orchestration:</strong> Coordination protocols and fault tolerance for production multi-agent systems</li>
                <li><i class="fas fa-satellite"></i> <strong>LEO Satellite Systems:</strong> Distributed processing architectures for low earth orbit constellations</li>
            </ul>
        </div>
    </section>
    ...
    <div class="quick-stats">
        ...
        <div class="stat-item">
            ...
            <div class="stat-label">Pending Publications</div>
        </div>
    </div>
